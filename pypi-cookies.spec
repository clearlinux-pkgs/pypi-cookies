...
License  : MIT
Requires: pypi-cookies-python = %{version}-%{release}
Requires: pypi-cookies-python3 = %{version}-%{release}
...
%package python
Summary: python components for the pypi-cookies package.
Group: Default
Requires: pypi-cookies-python3 = %{version}-%{release}

%description python
python components for the pypi-cookies package.


%package python3
Summary: python3 components for the pypi-cookies package.
Group: Default
Requires: python3-core
Provides: pypi(cookies)

%description python3
python3 components for the pypi-cookies package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656367455
